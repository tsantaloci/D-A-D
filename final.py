...
from tri_SMILES_COMB import tri_SMILES_COMB
...
def smilesRingCleanUp(f, s, t,j,k,type):
    if type == 'single' or type == 'dad':
        smi1, na1, form1 = f
        smi2, na2, form2 = s
        smi3, na3, form3 = t
    ...
    if type == 'triple':
        ...
        line = ''
        formalName = ''
        name = na1 + "_" + na4 + '_' + na5 + '_' + na2 + "_" + na3
        formalName = form1 + "::" + form2 + "::" + form3 + "::" + form4 + "::" + form5
        smi1 = f[0]
        smi2 = s[0]
        smi3 = t[0]
        smi4 = j[0]
        smi5 = k[0]
        print(name)
        line = tri_SMILES_COMB(smi1, smi2, smi3, smi4, smi5)

    return line, name, formalName


def generateSMILESinputs(smiles_tuple_list,type ):
    smiles = {}
    for num, i in enumerate(smiles_tuple_list):
        if type == 'single' or type == 'dad':
            first, second, third = i
            line, name, formalName = smilesRingCleanUp(first, second, third,'','',type)
        if type == 'triple':
            first, second, third, fourth, fifth = i
            line, name, formalName = smilesRingCleanUp(first, second, third, fourth, fifth, type)
...
def generateMolecules(
    ...
    for num, i in enumerate(smiles_tuple_list):
        ...
        if type == 'dad':
            ...
            if line == name and name == formalName:
                continue
            if mol_lst.checkMolecule(line, name):
                print(
                "\nMolecule already exists and the name smiles is... \n%s\n" %
...
#    typeofdye='single'
    typeofdye = 'dad'
#    results_json = 'triple.json'
    results_json = 'single.json'
    ...
    if typeofdye.lower()=='single':


      three_types = ["eDonors", "backbones", "eAcceptors"]
      banned = ['2ed','28b','29b','30b','31b','32b','33b','26b','34b','35b',"37b","38b","39b","40b","41b","42b","43b","44b","45b","12ea","13ea"]
      three_types = [
          "eDonors",
          "backbones",
          "eAcceptors",
    ...
    # cluster = "seq"
      ...
      smiles_dict = generateSMILESinputs(smiles_tuple_list,'single')
      print('smiles_dict:\n', smiles_dict)
      monitor_jobs = generateMolecules(
          ...
          cluster,
          'single',
          results_json="json_files/"+str(results_json),
      )
   
    if typeofdye.lower()=='triple':
        banned = ['7ea','9ea','10ea','11ea','13ea','1ed','2ed','3ed','12ed','21ed','1b','2b']
        three_types = [
          "trieDonors",
          "trieDonors",
          "trieDonors",
    ...
    if typeofdye.lower()=='dad':
        three_types = ["eDonors", "backbones", "eDonors_NIR"]
        method_opt = "B3LYP"
        basis_set_opt = "6-311G(d,p)"
        mem_com_opt = "1600"  # mb
        mem_pbs_opt = "10"  # gb
    ...
    #  # TD-DFT options
     ...
     # cluster = "seq"
        ...
        localStructuresDict = collectLocalStructures(three_types, banned)
        smiles_tuple_list = permutationDict(localStructuresDict)
        smiles_dict = generateSMILESinputs(smiles_tuple_list,'dad')
        print('smiles_dict:\n', smiles_dict)
        monitor_jobs = generateMolecules(
          smiles_tuple_list,
          method_opt,
